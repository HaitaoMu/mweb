...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
               	<table id="sapTable" data-url="<c:url value="/pageSapEntity"/>" data-height="400" data-side-pagination="server" data-pagination="true" data-page-list="[5, 10, 20, 50, 100, 200]" data-search="true" data-show-refresh="true" data-show-columns="true" data-query-params="queryParams">
				    <thead>
				    <tr>
