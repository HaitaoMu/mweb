...
<!--             </li> -->
            ...
            <li>
                 <a href='<c:url value="/listInterface" />'><i class="fa fa-cogs fa-fw"></i> Interface Manager<span class="fa arrow"></span></a>
            ...
            <li>
             	 <a  href='<c:url value="/menu" />'><i class="fa fa-star fa-fw"></i> Menu Manager</a>
            </li>
        </ul>
    </div>
    <!-- /.sidebar-collapse -->
